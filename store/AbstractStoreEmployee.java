...
public abstract class AbstractStoreEmployee implements Employee, Store {
     ...
     */
    @Override
    public double countWorkDays(){
        return numberOfHoursWorked / 24;
    }
     ...
     */
    @Override
    public double calculateCleanMonthlyStoreSales(double storeSales){
        return storeSales * 30;
    }
    
    /**
     * Menghitung gaji lembur pegawai
     * @author Yobel El'Roy Doloksaribu
     * @return - Hasil perhitungan
     */
    public abstract double calculateOverworkPayment(double hour);

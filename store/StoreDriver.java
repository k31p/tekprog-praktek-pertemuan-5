...
public class StoreDriver {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        // ? NEW: Add ArrayList for QA
        List<QualityAssurance> qualityAssuranceList = new ArrayList<QualityAssurance>();
        ...
        while (sc.hasNext()) {
            ...
            } else if (employeeType.equals("QA")){
                double winRate = sc.nextDouble();
                int productHandled = sc.nextInt();

                QualityAssurance qualityAssurance = new QualityAssurance(numberOfHoursWorked, hourlyRate, storeDetails, basePay, employeeType, winRate, productHandled);
        ...
        // ? NEW: For loop for Quality Assurance employee
        System.out.println("******************************************************");
        System.out.println("Number of employees working as QUALITY ASSURANCE are: " + qualityAssuranceList.size());
        System.out.println("******************************************************");
        pwd.println("******************************************************");
        pwd.println("Number of employees working as QUALITY ASSURANCE are: " + qualityAssuranceList.size());
        pwd.println("******************************************************");

        for (QualityAssurance qualityAssurance : qualityAssuranceList) {
            qualityAssuranceCount++;
            System.out.println(qualityAssuranceCount + ". Quality Assurance Details:");
            System.out.println(qualityAssurance);
            pwd.println(qualityAssurance);

            System.out.println("Total commission: $" + qualityAssurance.calculateCommission());
            System.out.println("Gross Payment: $" + qualityAssurance.calculatePay());
            pwd.println("Total commission: $" + qualityAssurance.calculateCommission());
            pwd.println("Gross Payment: $" + qualityAssurance.calculatePay());

            System.out.println("Win rate: " + qualityAssurance.getWinRate() + "%");
            System.out.println("Total products handled: " + qualityAssurance.getProductHandled());
            pwd.println("Win rate: " + qualityAssurance.getWinRate() + "%");
            pwd.println("Total products handled: " + qualityAssurance.getProductHandled());

            System.out.print("Is " + qualityAssurance.getEmployeeName() + " eligible for promotion? ");
            if (qualityAssurance.checkPromotionEligibility() == true) {
                System.out.println("Yes, he/she is eligible\n");
            } else {
                System.out.println("No, he/she needs to work harder\n");
            }
